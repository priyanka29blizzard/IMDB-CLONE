...
function Movies() {
    ...
    useEffect(() => {
        (function () {
            ...
            axios
                .get(` https://api.themoviedb.org/3/trending/movie/day?api_key=d42223835804f3ae060b28700e90f6b6&page=${pageNum}`)
                .then((res) => {
            ...
            <div className='flex flex-wrap'>
                ...
                {movies.map((movie) => {
                    return (<div
                        ...
                        <div className=' text-3xl p-1 absolute right-0  top-0 '
